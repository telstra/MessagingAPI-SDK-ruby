...
**reply_request** | **Boolean** | If set to true, the reply message functionality will be implemented. The &#x60;from&#x60; field should not be present.  | [optional] 
...
instance = Telstra_Messaging::SendMmsRequest.new(to: ,
                                 from: null,
                                 subject: null,
                                 reply_request: null,

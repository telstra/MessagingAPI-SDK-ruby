...
instance = Telstra_Messaging::SendSMSRequest.new(to: ,
                                 body: Test Message,
                                 from: Foo_App,
                                 validity: 5,

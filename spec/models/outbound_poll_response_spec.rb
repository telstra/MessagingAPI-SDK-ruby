...
# Unit tests for Telstra_Messaging::OutboundPollResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OutboundPollResponse' do
  before do
    # run before each test
    @instance = Telstra_Messaging::OutboundPollResponse.new
  end
  ...
  describe 'test an instance of OutboundPollResponse' do
    it 'should create an instance of OutboundPollResponse' do
      expect(@instance).to be_instance_of(Telstra_Messaging::OutboundPollResponse)
    end
  end

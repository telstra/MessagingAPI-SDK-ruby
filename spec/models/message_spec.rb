...
# Unit tests for Telstra_Messaging::Message
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Message' do
  before do
    # run before each test
    @instance = Telstra_Messaging::Message.new
  end
  ...
  describe 'test an instance of Message' do
    it 'should create an instance of Message' do
      expect(@instance).to be_instance_of(Telstra_Messaging::Message)
    end
  end
  ...
  describe 'test attribute "message_status_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

...
module Telstra_Messaging
  ...
  class Message
    ...
    def list_invalid_properties
      ...
      if @message_status_url.nil?
        invalid_properties.push("invalid value for 'message_status_url', message_status_url cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @message_status_url.nil?
      return true
    end

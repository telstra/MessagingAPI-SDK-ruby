...
module Telstra_Messaging
  ...
  class MessageSentResponse
    ...
    attr_accessor :number_national_destinations

    # This returns the number of international messages sent
    attr_accessor :number_international_destinations
    ...
    def self.swagger_types
      {
        ...
        :'number_national_destinations' => :'Integer',
        :'number_international_destinations' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'NumberNationalDestinations')
        self.number_national_destinations = attributes[:'NumberNationalDestinations']
      end

      if attributes.has_key?(:'NumberInternationalDestinations')
        self.number_international_destinations = attributes[:'NumberInternationalDestinations']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number_national_destinations == o.number_national_destinations &&
          number_international_destinations == o.number_international_destinations
    end
    ...
    def hash
      [messages, message_type, number_segments, number_national_destinations, number_international_destinations].hash
    end
